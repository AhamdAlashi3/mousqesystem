...
@section('title', 'Edit Surah')
@section('page-name', 'Edit Surah')
@section('main-page', 'Surah')
@section('sub-page', 'Edit Surah')
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Surah</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="create_form" >
                            ...
                            <div class=" card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ $surahs->name }}" placeholder="Enter name">
                                </div>
                            ...
                            <div class="card-footer">
                                <button type="button" onclick="update({{ $surahs->id }})" class="btn btn-primary">Updat</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
...
<script>
    ...
    function update(id) {
        ...
        axios.put('/cms/admin/surah/' + id, {
                name: document.getElementById('name').value,
                active: document.getElementById('active').value ? true : false,
        })
